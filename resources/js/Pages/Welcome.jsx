    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="-mx-4 -mt-4">
                ...
                {/* Category Groups (Horizontal Icons) */}
                <div className="mt-4 overflow-x-auto whitespace-nowrap scrollbar-hide px-2 pb-4">
                ...
                {/* Categories Bar */}
                <div className="bg-white mx-2 p-4 rounded-xl shadow-sm flex gap-6 items-center overflow-x-auto whitespace-nowrap scrollbar-hide border border-gray-100">
