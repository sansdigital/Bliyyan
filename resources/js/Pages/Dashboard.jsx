...
const STATS_CONFIG = [
    { key: 'pending',    label: 'Belum Bayar',   icon: 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z' }, // Card icon
    { key: 'processing', label: 'Dikemas',        icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' }, // Package icon
    { key: 'shipped',    label: 'Dikirim',        icon: 'M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 011 1v2a1 1 0 01-1 1m-4-4h4m-8 0H3' }, // Truck icon
    { key: 'to_review',  label: 'Beri Penilaian', icon: 'M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.175 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.382-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z' }, // Star icon
];

const MENU_ITEMS = [
    { label: 'Buku Alamat',  link: route('profile.edit'), icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z', color: 'bg-blue-500' },
    ...
    { label: 'Keranjang',    link: route('cart.index'), icon: 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z', color: 'bg-shopee' },
    { label: 'Keamanan', link: route('profile.edit'), icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', color: 'bg-green-600' },
];
            ...
            <div className="max-w-4xl mx-auto space-y-6 pb-20">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="px-6 py-4 flex items-center justify-between border-b border-gray-50">
                        ...
                        <Link href={route('orders.index')} className="text-xs text-shopee font-bold hover:underline">Lihat Semua Pesanan &rsaquo;</Link>
                    </div>
                ...
                <div className="pt-4">
                    <div className="flex items-center justify-between mb-4 px-2">
                        <h3 className="text-sm font-black text-gray-800 uppercase tracking-widest border-l-4 border-shopee pl-3">Rekomendasi Untuk Anda</h3>
